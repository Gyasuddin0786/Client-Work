...
<body style="margin:0;padding:0;background:${lightBg};font-family:Arial,Helvetica,sans-serif;">
...
<tr>
  <td style="background:${darkColor};padding:35px;text-align:center;">
    ...
    <h1 style="margin:0;color:${primaryColor};font-size:30px;">
      ${companyName}
    </h1>

    <p style="margin-top:10px;color:#d1d5db;font-size:16px;">
...
<h2 style="margin-top:0;color:${darkColor};">
${title}
</h2>

...
<div className="absolute inset-0 overflow-hidden">
  ...
  <div className="absolute inset-0 bg-gradient-to-t from-orange-500/10 via-transparent to-transparent" />
      ...
      <Container>
        <div className="relative overflow-hidden rounded-[32px] border border-white/10 bg-white/5 p-10 shadow-2xl backdrop-blur-lg lg:p-8">
          ...
          <div className="grid items-center gap-12 lg:grid-cols-[1.5fr_auto]">
            ...
            <div>
              ...
              <span className="inline-flex rounded-full border border-orange-500/30 bg-orange-500/10 px-4 py-2 text-sm font-medium text-orange-300">
                Ready to Start?
              </span>
              ...
              <div className="mt-8 flex flex-wrap gap-4">
                ...
                <div className="flex items-center gap-3 rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-slate-300 hover:border-orange-300">

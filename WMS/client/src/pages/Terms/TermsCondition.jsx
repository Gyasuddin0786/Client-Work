      ...
      <Container>
        ...
        "
          >
            ...
            <p className="mt-5 leading-8 text-slate-600">
              Every quotation is prepared based on the information provided
              by the customer. Any changes in design, dimensions,
              materials or project scope may result in an updated estimate.
            </p>
        ...
        "
          >
            ...
            <ul className="mt-5 space-y-3 text-slate-600">
              ...
              <li>• Remaining balance is payable after project completion.</li>
        ...
        "
          >
            ...
            <p className="mt-5 leading-8 text-slate-600">
              ...
              committed to completing every project within the agreed
              timeline while maintaining high-quality workmanship.
            </p>
        ...
        "
          >
            ...
            <p className="mt-5 leading-8 text-slate-600">
              We stand behind the quality of our workmanship. Warranty
              covers manufacturing and workmanship defects only. Damage
              caused by accidents, misuse, poor maintenance, corrosion,
              unauthorized modifications or natural disasters is not
              covered.
            </p>
        ...
        "
          >
            ...
            <p className="mt-5 leading-8 text-slate-600">
              Our liability is limited to the value of the services
              provided. We are not responsible for indirect,
              consequential or incidental losses resulting from delays,
              misuse or circumstances beyond our control.
            </p>
        ...
        "
          >
            ...
            <p className="mt-5 leading-8 text-slate-600">
              ...
              Any revisions will be published on this website and become
